          ...
          <div className="lg:sticky lg:top-24 space-y-6 sm:space-y-7 md:space-y-8 flex flex-col">
            ...
            <div className="flex justify-center lg:justify-start pt-2 sm:pt-4">
              <button
                ...
                className="w-full max-w-xs lg:max-w-none px-4 sm:px-5 py-2 sm:py-2.5 bg-primary text-primary-foreground rounded-lg text-xs sm:text-sm font-medium hover:bg-primary/90 transition-all touch-manipulation"
              >
                View All Projects
              </button>
            </div>
